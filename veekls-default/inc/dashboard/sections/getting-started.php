...
<div id="getting-started" class="gt-tab-pane gt-is-active">
	<div class="feature-section two-col">
		<div class="col">
			...
			<p>
				<?php echo esc_html(sprintf(__('We have made a list of steps for you, to make sure you will get the most of %s. They are easy to follow.', 'veekls'), $this->theme->name)); ?>
			</p>
			<p>
			...
			<p>
				<a href="<?php echo esc_url("https://wpautolistings.com/docs/{$this->slug}/{$this->utm}"); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Read Documentation', 'veekls');?></a>
			</p>
		</div>
