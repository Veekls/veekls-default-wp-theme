...
<div id="actions" class="gt-tab-pane">
	...
	<?php if ($this->jetpack_is_recommended()): ?>
		...
		<p>
			<?php echo esc_html(sprintf(__('%s uses Jetpack to support featured content, social menu. Connect to Jetpack to use these features as well as variety of other tools.', 'veekls'), $this->theme->name)); ?>
		</p>
	...
	<h3><?php esc_html_e('Import Demo Data (Optional)', 'veekls');?></h3>
	<p><?php esc_html_e('Import demo data if you want your website exactly the same as our demo.', 'veekls');?></p>
	<a class="button" href="<?php echo esc_url(admin_url('themes.php?page=pt-one-click-demo-import')); ?>"><?php esc_html_e('Import Demo Now', 'veekls');?></a>
</div>
