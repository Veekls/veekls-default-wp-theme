    ...
    public function notice()
    {
        ...
        if (is_admin() && isset($_GET['activated']) && 'themes.php' === $pagenow) {
			...
			<div class="updated notice notice-success is-dismissible">
				<p>
					<?php echo wp_kses_post(sprintf(__('Welcome! Thank you for choosing %1$s. To get started, visit our <a href="%2$s">welcome page</a>.', 'veekls'), $this->theme->name, esc_url(admin_url('themes.php?page=' . $this->slug)))); ?>
				</p>
				<p>
					<a class="button" href="<?php echo esc_url(admin_url('themes.php?page=' . $this->slug)); ?>">
						<?php echo esc_html(sprintf(__('Get started with %s', 'veekls'), $this->theme->name)); ?>
					</a>
				</p>
			</div>
			<?php
